...
RED_SPACE_SHIP = pygame.image.load(
    os.path.join("assets", "ship_red_small.png"))
GREEN_SPACE_SHIP = pygame.image.load(
    os.path.join("assets", "ship_green_small.png"))
BLUE_SPACE_SHIP = pygame.image.load(
    os.path.join("assets", "ship_blue_small.png"))

# Player Ship
YELLOW_SPACE_SHIP = pygame.image.load(
    os.path.join("assets", "ship_yellow.png"))

# Lasers
RED_LASER = pygame.image.load(os.path.join("assets", "laser_red.png"))
GREEN_LASER = pygame.image.load(
    os.path.join("assets", "laser_green.png"))
YELLOW_LASER = pygame.image.load(
    os.path.join("assets", "laser_yellow.png"))
...
def main():
    ...
    def redraw_window():
        ...
        WIN.blit(
            lives_label, (WIDTH - lives_label.get_width() - 10, 10))
    ...
    while run:
        ...
        if (keys[pygame.K_RIGHT] or keys[pygame.K_d]) and player.x + player_velocity + player.get_width() < WIDTH:  # right
            player.x += player_velocity
        if (keys[pygame.K_UP] or keys[pygame.K_w]) and player.y - player_velocity > 0:  # up
            player.y -= player_velocity
        if (keys[pygame.K_DOWN] or keys[pygame.K_s]) and player.y + player_velocity + player.get_height() < HEIGHT:
            player.y += player_velocity
